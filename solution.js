function calc(firstNumber, secondNumber, operation, result) {
  ...
  if (firstNumber < 1) {
    console.log('ERROR: First number you entered is less than 1, please enter the bigger number.');
    return false;
  }
  ...
  if (secondNumber < 1) {
    console.log('ERROR: Second number you entered is less than 1, please enter the bigger number.');
    return false;
  }
  ...
  if (result < 1) {
    console.log('ERROR: the result you entered is less than 1, please enter the bigger number.');
    return false;
  }
  ...
  console.log('resultParam=', resultParam);
  console.log('operationResult === resultParam is: ', operationResult === resultParam);
